      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center ">
          ...
          <div className="hidden md:flex items-center gap-1 lg:gap-2">
            ...
            <a href="/services" className={`px-3 py-2 text-sm lg:text-base font-semibold text-white/90 hover:text-yellow-400 rounded-lg transition-all whitespace-nowrap ${pathname === '/services' ? 'text-yellow-400 !important ' : ''}`}>
              Services
            </a>
            <a href="/portfolio" className={`px-3 py-2 text-sm lg:text-base font-semibold text-white/90 hover:text-yellow-400 rounded-lg transition-all whitespace-nowrap ${pathname === '/portfolio' ? 'text-yellow-400 !important ' : ''}`}>
              Portfolio
            </a>
            <a href="/about" className={`px-3 py-2 text-sm lg:text-base font-semibold text-white/90 hover:text-yellow-400 rounded-lg transition-all whitespace-nowrap ${pathname === '/about' ? 'text-yellow-400 !important ' : ''}`}>
              About
            </a>
            <a href="/contact" className={`px-3 py-2 text-sm lg:text-base font-semibold text-white/90 hover:text-yellow-400 rounded-lg transition-all whitespace-nowrap ${pathname === '/contact' ? 'text-yellow-400 !important ' : ''}`}>
              Contact Us
            </a>
          </div>
        ...
        {/* Mobile Menu - ADD same "active" styling */}
        {mobileOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-gradient-to-b from-gray-900 to-black/90 backdrop-blur-2xl border-t border-white/10 shadow-2xl py-6 px-4 animate-in slide-in-from-top-4 duration-300">
            <div className="space-y-3">
              ...
              <a href="/contact" className={`block py-4 px-6 text-xl font-bold text-white hover:text-yellow-400 hover:bg-white/10 rounded-2xl transition-all duration-200 ${pathname === '/contact' ? 'text-yellow-400 !important bg-white/20 ' : ''}`} onClick={() => setMobileOpen(false)}>
                Contact
              </a>
              {/* CTAs unchanged */}
