            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-3 mt-8 lg:mt-12 rounded-2xl border border-white/30">
                  ...
                  <span className="text-white font-bold text-lg">MH/2026/001 Licensed Developer</span>
                </div>
                ...
                <div className="pb-12 lg:pb-20">
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="/projects" className="border-2 border-white text-white py-4 px-8 rounded-2xl font-bold text-lg hover:bg-white hover:text-gray-900 transition-all duration-300">
                      Our Projects
                    </a>
                  </div>
                </div>
      ...
      <div className="relative -mt-20 lg:-mt-32 pt-40 lg:pt-52 pb-20 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-24 pt-8">
            ...
            <div className="inline-block bg-white/95 backdrop-blur-md px-8 py-4 rounded-2xl border border-white/60 shadow-xl mx-6 translate-y-4">
              <p className="text-lg md:text-xl font-semibold text-gray-900 tracking-wide">
                MH/2026/001 Licensed • 100+ Acres Developed • PMRDA Approved Projects
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto pb-16">
            <a href="/projects/ahilya-orchards" className="group block p-10 lg:p-12 bg-white/5 backdrop-blur-3xl border border-white/20 hover:border-amber-400/70 rounded-3xl hover:shadow-2xl hover:bg-white/15 transition-all duration-700 hover:-translate-y-3">
            ...
            <a href="/projects/golden-gates" className="group block p-10 lg:p-12 bg-white/5 backdrop-blur-3xl border border-white/20 hover:border-amber-400/70 rounded-3xl hover:shadow-2xl hover:bg-white/15 transition-all duration-700 hover:-translate-y-3">
