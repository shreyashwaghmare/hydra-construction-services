...
export default function Portfolio() {
    ...
    <div className="min-h-screen bg-gray-50 py-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">50+ Pune projects delivered</p>
        </div>

        {/* SIMPLE 2-COLUMN GRID - 100% WORKING */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
  ...
  target="_blank"
  className="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-6 py-3 rounded-xl font-bold text-center flex-1 flex items-center justify-center gap-2 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
>
                    💬 Get Quote
                  ...
                  <a 
                    ...
                    className="bg-gray-800 hover:bg-gray-900 text-white px-6 py-3 rounded-xl font-bold text-center flex-1"
                  >
                    View Details
                  </a>
                </div>
        ...
        {/* CTA */}
{/* BEST OF BOTH WORLDS -  CTA section */}
{/* CLEAN CTA - Replace your entire CTA section */}
